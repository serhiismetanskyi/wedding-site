;(function () {
	...
	// Set the date we're counting down to
		...
		// Display the result in an element with id="demo"
		document.getElementById("days").innerHTML = days +" <small>днів</small>";
		document.getElementById("hours").innerHTML = hours + " <small>годин</small> ";
		document.getElementById("minutes").innerHTML = minutes + " <small>хвилин</small> ";
